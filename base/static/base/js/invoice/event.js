$(document).ready(function () {
    ...
    function step3Settings() {
        ...
        $('.btn-next.finish > span').text("Finalizar");
        $('.btn-next.finish > i').removeClass('fa-arrow-right');
        $('.btn-next.finish > i').addClass('fa-save');
        $('.btn-next.send').removeClass('hidden');

        var finish_send_url = '/'+ model_name + '/finish_send/'+localStorage.getItem('proposalId');

        $('.btn-next.send').attr('href',finish_send_url);
                    ...
                    $.ajax({
                            ...
                            success: function (data, textStatus) {
                                ...
                                if(model_name == 'proposal'){
                                  ...
                                  toastr.error("Ha existido un error al procesar su solicitud, por favor intente más tarde. Si el error persiste contacte al administrador del sistema");
                                }
...
//        });
    ...
    $("#save_edit_event").click(function(){
