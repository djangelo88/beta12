...
angular.module('proposals-angular-wizard', ['templates-angularwizard']);

angular.module('proposals-angular-wizard').directive('wzStep', function () {
    return {
        restrict: 'EA',
        replace: true,
        transclude: true,
...
//wizard directive
angular.module('proposals-angular-wizard').directive('wizard', function () {
    return {
        restrict: 'EA',
        replace: true,
        transclude: true,
...
function wizardButtonDirective(action) {
    angular.module('proposals-angular-wizard')
...
angular.module('proposals-angular-wizard').factory('WizardHandler', function () {
    var service = {};
