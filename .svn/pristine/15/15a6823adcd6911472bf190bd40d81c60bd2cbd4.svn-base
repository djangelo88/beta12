...
urlpatterns = [
      ...
      url(r'^accounts/password_reset/done/', password_reset_done,
          {'template_name': 'beta/reset/password_reset_done.html'}, name="password_reset_done"),
      ...
      url(r'^accounts/reset/done/', password_reset_complete,
          {'template_name': 'beta/reset/password_reset_complete.html'}, name="password_reset_complete"),
      url(
      ...
      url(r'^api/', include('base.urlsapi')),
