...
from base.api.views.website_view import AllWebsiteData, WebsiteBasics, LogoSave, ContactUs, ContactUsView, \
    SocialNetworks, TemplateVew, UnpublishPublish, PhotoGallerySave, DataPhotoGallerySave, Gallery, GalleryView
...
urlpatterns = [
    ...
    url(r'^photogallerysave/(?P<id>\d+)/$', login_required(PhotoGallerySave.as_view()), name='photogallerysave_edit'),
    url(r'^dataphotogallerysave', login_required(DataPhotoGallerySave.as_view()), name='dataphotogallerysave'),
    url(r'^gallery', login_required(GalleryView.as_view()), name='gallery'),
