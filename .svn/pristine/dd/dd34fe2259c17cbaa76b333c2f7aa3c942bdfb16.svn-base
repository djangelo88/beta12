...
class Website(models.Model, ModelSerialize):
    ...
    status = models.IntegerField(default=0)#0-Created 1-Published
    business = models.ForeignKey(Business, default=0, related_name='website')

    def __str__(self):
        return self.business.name

    default_fields = ['id', 'template', 'status', 'business', 'basicinfo', 'gallery', 'category', 'staffservice', 'links', 'contactus']
