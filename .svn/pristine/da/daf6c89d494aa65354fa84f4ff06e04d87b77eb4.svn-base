...
import django_excel
import pyexcel
from base.api.forms import CustomerForm, CustomerImportForm
from base.api.util import serialize_query
from base.forms import EventForm, TestForm
...
class ImportView(View):
   ...
   def post(self, request):
       ...
       if form.is_valid():
           ...
           result = pyexcel.get_sheet(file_type=params.get('file_type'), file_content=params.get('file_content'),
                                      colnames=['Apellidos','Ciudad','Codigo Postal','Compania','Correo','Estado','Fecha de Nacimiento','Line 1',
